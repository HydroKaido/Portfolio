    ...
    <>
      <div className="flex justify-center items-center mb-3 mx-5 mt-10">
        <div className="md:w-[750px] xl:w-[800px]">
          <div className="mb-3 font-bold">PROJECT</div>
            ...
            <div className="card border border-gray-300 rounded-lg shadow-lg  mb-5">
              ...
              <div className="border-b-2">
                <div className="ms-3 my-2 font-bold">
                  <div>Zephyderm: Appointment System and</div>
                  <div>Client Monitoring</div>
                </div>
              </div>
              <div className="border-b-2">
              ...
              <div className="grid grid-cols-3">
                <h2 className="border-2 rounded text-center px-2 mx-2 text-xs my-2">
                  HTML
                </h2>
                <h2 className="border-2 rounded text-center px-2 mx-2 text-xs my-2">
                  CSS
                ...
                <h2 className="border-2 rounded text-center px-2 mx-2 text-xs mb-2 ">
                  JAVASCRIPT
                </h2>
                <h2 className="border-2 rounded text-center px-2 mx-2 text-xs mb-2">
                  JQUERY
      ...
      <div>
        <Link
          to={"/project"}
          className="flex justify-center mb-5 group hover:text-blue-500"
        >
