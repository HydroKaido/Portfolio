const ExperienceComponet = () => {
    return ( 
        <>
        <div className="flex justify-center items-center mb-3 mx-5 mt-10">
          <div className="md:w-[750px] xl:w-[800px]">
            <div className="mb-3 text-xl tracking-wide font-bold text-white/90 font-mono ms-2">EXPERIENCE</div>
...
export default ExperienceComponet;